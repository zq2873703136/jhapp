						...
						<view class="mt-16 flex-row items-center self-stretch">
							...
							<view class="ml-8 flex-col">
								<view class="flex-row self-stretch">
									...
									<text class="ml-6 self-start font_2">{{item.supplyDate}}</text>
								</view>
								<text class="self-stretch font_3 text_4">签订日期：{{item.invoiceDate}}</text>
								<text class="self-stretch font_3">状态：{{item.taskSheetStatus}}</text>
								<text class="self-start font_3">施工单位：{{item.pumpingMachine}}</text>
							</view>
						</view>
					</view>
				</view>
