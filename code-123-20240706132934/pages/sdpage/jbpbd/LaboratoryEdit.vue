...
export default {
    ...
    methods: {
        ...
        jisuan() {
            this.form2.rl = Number(this.form2.ds) + Number(this.form2.zs1) + Number(this.form2.zs2) + Number(this.form2.xs) + Number(this.form2.s1) +
                Number(this.form2.s2) + Number(this.form2.b) + Number(this.form2.sn1) + Number(this.form2.sn2) + Number(this.form2.fmh1) + Number(
