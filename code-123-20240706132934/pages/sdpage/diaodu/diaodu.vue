						...
						<view class="mt-16 data-group">
							...
							<view class="data-row">
								<view class="data-item">
									<text class="data-item"><text class="title-green">流水号：</text>{{ item.xh }}</text>
								</view>
								<view class="data-item">
									<text class="data-item"><text class="title-green">车道号：</text>{{ item.cdh }}</text>
								</view>
								<view class="data-item">
									<text class="data-item"><text class="title-green">任务单号：</text>{{ item.rwdh }}</text>
								</view>
								<view class="data-item">
									<text class="data-item"><text class="title-green">配比编号：</text>{{ item.pbbh }}</text>
								</view>
							</view>

							<view class="data-row">
								<view class="data-item">
									<text class="data-item"><text class="title-green">用户名称：</text>{{ item.yhmc }}</text>
								</view>
							</view>
							<view class="data-row">
								<view class="data-item">
									<text class="data-item"><text class="title-green">工程名称：</text>{{ item.gcmc }}</text>
								</view>
							</view>
							<view class="data-row">
								<view class="data-item">
								...
								<view class="data-item">
									<text class="data-item"><text class="title-green">车编号：</text>{{ item.cbh }}</text>
								</view>
								<view class="data-item">
							...
							<view class="data-row">
								<view class="data-item">
									<text class="data-item"><text class="title-green">车载方量：</text>{{ item.czfl }}</text>
								</view>
								<view class="data-item">
									<text class="data-item"><text class="title-green">时间：</text>{{ item.sj }}</text>
								</view>
								<view class="data-item">
									<text class="data-item"><text class="title-green">状态：</text>{{zhuangtaifun (item)}}</text>
								</view>
							</view>
						</view>
					</view>
