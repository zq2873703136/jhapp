		...
		<view class="flex-col section_3 pos_10">
			...
			<view class="flex-col group_2">
				...
				<view class="flex-row justify-between self-stretch group_3">
					<view class="self-start font_2">
						<picker mode="date" :value="form2.supplyDate" start="1900-01-01" end="2100-12-31"
							@change="bindDateChange">
							<view>{{form2.supplyDate || '请选择日期'}}</view>
						</picker>
					</view>
			...
			<view class="flex-col group_2">
				...
				<view class="flex-col items-start input group_4">
					...
					<input class="mt-12 font_2" v-model="form2.contractCode" />
				</view>
				<view class="flex-col items-start input group_4">
					<text class="font text_6">施工单位</text>
					<input class="mt-12 font_2" v-model="form2.constructionSite" />
				</view>
				<view class="flex-col items-start input group_4">
					<text class="font text_6">工程名称</text>
					<input class="mt-12 font_2" v-model="form2.projectName" />
				</view>
				<view class="flex-col items-start input group_4">
					<text class="font text_6">工程部位</text>
					<input class="mt-12 font_2" v-model="form2.projectPosition" />
				</view>
				<view class="flex-col items-start input group_4">
					<text class="font text_6">计划方量</text>
					<input class="mt-12 font_2" v-model="form2.planConcreteQuantity" />
				</view>
				<view class="flex-col items-start input group_4">
					<text class="font text_6">公里数</text>
					<input class="mt-12 font_2" v-model="form2.distance" />
				</view>
				<view class="flex-col items-start input group_4">
					<text class="font text_6">强度等级</text>
					<input class="mt-12 font_2" v-model="form2.strengthGrade" />
				</view>
				<view class="flex-col items-start input group_4">
					<text class="font text_6">抗渗等级</text>
					<input class="mt-12 font_2" v-model="form2.impermeabilityGrade" />
				</view>
				<view class="flex-col items-start input group_4">
					<text class="font text_6">施工坍落度</text>
					<input class="mt-12 font_2" v-model="form2.constructionSlump" />
				</view>
			</view>
			<view class="flex-col group_2">
				...
				<view class="flex-col items-start input group_4">
					...
					<input class="mt-12 font_2" v-model="form2.pumpingMachine" />
				</view>
				<view class="flex-col items-start input group_4">
					<text class="font text_6">泵送机械</text>
					<input class="mt-12 font_2" v-model="form2.pumpingPipe" />
				</view>
				<view class="flex-col items-start input group_4">
					<text class="font text_6">膨胀剂型号</text>
					<input class="mt-12 font_2" v-model="form2.expansionType" />
				</view>
				<view class="flex-col items-start input group_4">
					<text class="font text_6">摻量</text>
					<input class="mt-12 font_2" v-model="form2.dosage" />
				</view>
			</view>
			...
			async save() {
				try {
					const res = await taskSheetSave({
						id: this.form2.pickerIndexid,
						taskSheetCode: this.form2.taskSheetCode,
						contractCode: this.form2.contractCode,
						// ... 其他属性，使用 this.propertyName 来访问  
						supplyDate: this.form2.supplyDate,
						planDate: this.form2.planDate,
						constructionSite: this.form2.constructionSite,
						projectName: this.form2.projectName,
						projectPosition: this.form2.projectPosition,
						planConcreteQuantity: this.form2.planConcreteQuantity,
						remainConcreteQuantity: this.form2.remainConcreteQuantity,
						distance: this.form2.distance,
						strengthGrade: this.form2.strengthGrade,
						impermeabilityGrade: this.form2.impermeabilityGrade,
						pumpingType: this.form2.pumpingType,
						pumpingParams: this.form2.pumpingParams,
						constructionSlump: this.form2.constructionSlump,
